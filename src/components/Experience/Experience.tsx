...
export const Experience = () => {
    return (
        <section id="experience" className=".container mt-[79px] ml-[10%] mr-[10%]">
            <h2 className="title text-[35px] font-[700] tracking-[1.75px] uppercase">Experience</h2>
            <div className="content flex justify-evenly mt-[14px] max-[830px]:flex-col max-[830px]:items-center max-[830px]:gap-[34px]">
                <div className="skills w-[45%] flex flex-wrap gap-[37px] max-[830px]:w-[100%] max-[830px]:flex-row max-[830px]:justify-center">
                    {skills.map((skill, id) => {
                        return (
                ...
                <ul className="history flex flex-col gap-[40px] max-[830px]:w-[100%] max-[830px]:gap-[9px]">
                    {
